...
if [  -f /sbin/data/tailscale ];then
ln -s /sbin/data/tailscale /usr/sbin/tailscale
ln -s /sbin/data/tailscaled /usr/sbin/tailscaled
...
#tailscale up --reset --accept-routes=true --force-reauth --accept-dns=false --login-server=https://headscale.3666673.xyz
tailscale_start(){
