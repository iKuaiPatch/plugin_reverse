...
md5sum $plugin_dir/../data/easytier-cli | awk '{print $1}' | grep -qf $plugin_dir/md5s || exit
md5sum $plugin_dir/../data/easytier-core | awk '{print $1}' | grep -qf $plugin_dir/md5s || exit
md5sum $plugin_dir/../data/easytier-web | awk '{print $1}' | grep -qf $plugin_dir/md5s || exit
...
if [ ! -f /usr/sbin/easytier-cli ];then
chmod +x $plugin_dir/../data/easytier-cli
ln -s $plugin_dir/../data/easytier-cli /usr/sbin/easytier-cli
fi


if [ ! -f /usr/sbin/easytier-web ];then
chmod +x $plugin_dir/../data/easytier-cli
ln -s $plugin_dir/../data/easytier-web /usr/sbin/easytier-web
fi
